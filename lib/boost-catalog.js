...
export const TURBO_SERVICES = [
  {
    id: 'instagram', name: 'Instagram', color: '#e1306c',
    packages: [
      { id: 'tb_ig_f50_avg',   name: '50 Followers (Avg)',     price: 200,   delivery: '1hr',   desc: 'Average quality', service_id: 3106, quantity: 50     },
      { id: 'tb_ig_f1k_avg',   name: '1,000 Followers (Avg)',  price: 4000,  delivery: '1hr',   desc: 'Average quality', service_id: 3106, quantity: 1000   },
      { id: 'tb_ig_f20_hq',    name: '20 Followers (HQ)',      price: 140,   delivery: '11min', desc: 'High quality',    service_id: 3107, quantity: 20     },
      { id: 'tb_ig_f1k_hq',    name: '1,000 Followers (HQ)',   price: 6000,  delivery: '11min', desc: 'High quality',    service_id: 3107, quantity: 1000   },
      { id: 'tb_ig_f5k_avg',   name: '5,000 Followers (Avg)',  price: 21000, delivery: '1hr',   desc: 'Average quality', service_id: 3106, quantity: 5000   },
      { id: 'tb_ig_f5k_hq',    name: '5,000 Followers (HQ)',   price: 32000, delivery: '11min', desc: 'High quality',    service_id: 3107, quantity: 5000   },
      { id: 'tb_ig_l300_avg',  name: '300 Likes (Avg)',        price: 140,   delivery: '5min',  desc: 'Average quality', service_id: 2997, quantity: 300    },
      { id: 'tb_ig_l1k_avg',   name: '1,000 Likes (Avg)',      price: 500,   delivery: '5min',  desc: 'Average quality', service_id: 2997, quantity: 1000   },
      { id: 'tb_ig_l150_hq',   name: '150 Likes (HQ)',         price: 140,   delivery: '5min',  desc: 'High quality',    service_id: 2998, quantity: 150    },
      ...
      { id: 'tb_ig_v5k_hq',    name: '5,000 Views (HQ)',       price: 170,   delivery: '31min', desc: 'Reel / Video',    service_id: 3109, quantity: 5000   },
      ...
      { id: 'tb_ig_v100k_hq',  name: '100,000 Views (HQ)',     price: 3200,  delivery: '31min', desc: 'Reel / Video',    service_id: 3109, quantity: 100000 },
    ]
  },
  {
    id: 'tiktok', name: 'TikTok', color: '#ff0050',
    packages: [
      { id: 'tb_tt_f20_avg',   name: '20 Followers (Avg)',     price: 160,   delivery: '1hr',   desc: 'Average quality', service_id: 3036, quantity: 20     },
      { id: 'tb_tt_f1k_avg',   name: '1,000 Followers (Avg)',  price: 8000,  delivery: '1hr',   desc: 'Average quality', service_id: 3036, quantity: 1000   },
      { id: 'tb_tt_f20_hq',    name: '20 Followers (HQ)',      price: 200,   delivery: '7hrs',  desc: 'High quality',    service_id: 3037, quantity: 20     },
      ...
      { id: 'tb_tt_l150_avg',  name: '150 Likes (Avg)',        price: 150,   delivery: '29min', desc: 'Average quality', service_id: 3048, quantity: 150    },
      { id: 'tb_tt_l1k_avg',   name: '1,000 Likes (Avg)',      price: 1000,  delivery: '29min', desc: 'Average quality', service_id: 3048, quantity: 1000   },
      { id: 'tb_tt_l100_hq',   name: '100 Likes (HQ)',         price: 140,   delivery: '32min', desc: 'High quality',    service_id: 3049, quantity: 100    },
      { id: 'tb_tt_l1k_hq',    name: '1,000 Likes (HQ)',       price: 1250,  delivery: '32min', desc: 'High quality',    service_id: 3049, quantity: 1000   },
      { id: 'tb_tt_l5k_avg',   name: '5,000 Likes (Avg)',      price: 5000,  delivery: '29min', desc: 'Average quality', service_id: 3048, quantity: 5000   },
      { id: 'tb_tt_l5k_hq',    name: '5,000 Likes (HQ)',       price: 6300,  delivery: '32min', desc: 'High quality',    service_id: 3049, quantity: 5000   },
      { id: 'tb_tt_v1k_avg',   name: '1,000 Views (Avg)',      price: 140,   delivery: '12min', desc: 'Video views',     service_id: 3047, quantity: 1000   },
      { id: 'tb_tt_v750_hq',   name: '750 Views (HQ)',         price: 150,   delivery: '5min',  desc: 'Video views',     service_id: 3043, quantity: 750    },
      { id: 'tb_tt_v50k_avg',  name: '50,000 Views (Avg)',     price: 6500,  delivery: '12min', desc: 'Video views',     service_id: 3047, quantity: 50000  },
      { id: 'tb_tt_v50k_hq',   name: '50,000 Views (HQ)',      price: 9500,  delivery: '5min',  desc: 'Video views',     service_id: 3043, quantity: 50000  },
      { id: 'tb_tt_v500k_avg', name: '500,000 Views (Avg)',    price: 65000, delivery: '12min', desc: 'Viral boost',     service_id: 3047, quantity: 500000 },
      { id: 'tb_tt_v500k_hq',  name: '500,000 Views (HQ)',     price: 95000, delivery: '5min',  desc: 'Viral boost',     service_id: 3043, quantity: 500000 },
    ]
  },
  {
    id: 'facebook', name: 'Facebook', color: '#1877f2',
    packages: [
      { id: 'tb_fb_pgf50_avg',   name: '50 Page Followers (Avg)',       price: 200,  delivery: '3hrs',  desc: 'Average quality', service_id: 3123, quantity: 50    },
      ...
      { id: 'tb_fb_pgf20_hq',    name: '20 Page Followers (HQ)',        price: 140,  delivery: '4hrs',  desc: 'High quality',    service_id: 3124, quantity: 20    },
      { id: 'tb_fb_pgf1k_hq',    name: '1,000 Page Followers (HQ)',     price: 6000, delivery: '4hrs',  desc: 'High quality',    service_id: 3124, quantity: 1000  },
      { id: 'tb_fb_prf50_avg',   name: '50 Profile Followers (Avg)',    price: 200,  delivery: '6hrs',  desc: 'Average quality', service_id: 3125, quantity: 50    },
      ...
      { id: 'tb_fb_prf20_hq',    name: '20 Profile Followers (HQ)',     price: 140,  delivery: '1hr',   desc: 'High quality',    service_id: 3126, quantity: 20    },
      ...
      { id: 'tb_fb_pl200_avg',   name: '200 Post Likes (Avg)',          price: 140,  delivery: '26min', desc: 'Average quality', service_id: 3129, quantity: 200   },
      { id: 'tb_fb_pl1k_avg',    name: '1,000 Post Likes (Avg)',        price: 700,  delivery: '26min', desc: 'Average quality', service_id: 3129, quantity: 1000  },
      { id: 'tb_fb_pl150_hq',    name: '150 Post Likes (HQ)',           price: 140,  delivery: '1hr',   desc: 'High quality',    service_id: 3130, quantity: 150   },
      { id: 'tb_fb_pl1k_hq',     name: '1,000 Post Likes (HQ)',         price: 900,  delivery: '1hr',   desc: 'High quality',    service_id: 3130, quantity: 1000  },
      { id: 'tb_fb_react_love150',  name: '150 Reactions ❤️',          price: 140,  delivery: '2hrs',  desc: 'Love reaction',   service_id: 3131, quantity: 150   },
      { id: 'tb_fb_react_love',  name: '1,000 Reactions ❤️',            price: 900,  delivery: '2hrs',  desc: 'Love reaction',   service_id: 3131, quantity: 1000  },
      { id: 'tb_fb_react_haha150',  name: '150 Reactions 😂',          price: 140,  delivery: '55min', desc: 'Haha reaction',   service_id: 3133, quantity: 150   },
      { id: 'tb_fb_react_haha',  name: '1,000 Reactions 😂',            price: 900,  delivery: '55min', desc: 'Haha reaction',   service_id: 3133, quantity: 1000  },
      { id: 'tb_fb_react_wow150',   name: '150 Reactions 😮',          price: 140,  delivery: '3hrs',  desc: 'Wow reaction',    service_id: 3132, quantity: 150   },
      { id: 'tb_fb_react_wow',   name: '1,000 Reactions 😮',            price: 900,  delivery: '3hrs',  desc: 'Wow reaction',    service_id: 3132, quantity: 1000  },
      { id: 'tb_fb_react_sad150',   name: '150 Reactions 😢',          price: 140,  delivery: '29min', desc: 'Sad reaction',    service_id: 3134, quantity: 150   },
      { id: 'tb_fb_react_sad',   name: '1,000 Reactions 😢',            price: 900,  delivery: '29min', desc: 'Sad reaction',    service_id: 3134, quantity: 1000  },
      { id: 'tb_fb_react_angry150', name: '150 Reactions 😡',          price: 140,  delivery: '8min',  desc: 'Angry reaction',  service_id: 3135, quantity: 150   },
      { id: 'tb_fb_react_angry', name: '1,000 Reactions 😡',            price: 900,  delivery: '8min',  desc: 'Angry reaction',  service_id: 3135, quantity: 1000  },
      { id: 'tb_fb_shares100',   name: '100 Post Shares',               price: 200,  delivery: '4min',  desc: 'High quality',    service_id: 2975, quantity: 100   },
      { id: 'tb_fb_shares',      name: '1,000 Post Shares',             price: 2200, delivery: '4min',  desc: 'High quality',    service_id: 2975, quantity: 1000  },
      { id: 'tb_fb_grp50_avg',   name: '50 Group Members (Avg)',        price: 140,  delivery: '1hr',   desc: 'Average quality', service_id: 2932, quantity: 50    },
      ...
      { id: 'tb_fb_grp50_hq',    name: '50 Group Members (HQ)',         price: 200,  delivery: '3hrs',  desc: 'High quality',    service_id: 3136, quantity: 50    },
      { id: 'tb_fb_grp1k_hq',    name: '1,000 Group Members (HQ)',      price: 4000, delivery: '3hrs',  desc: 'High quality',    service_id: 3136, quantity: 1000  },
      { id: 'tb_fb_v750_avg',    name: '750 Video Views (Avg)',         price: 150,  delivery: '2hrs',  desc: 'Average quality', service_id: 3137, quantity: 750   },
      { id: 'tb_fb_v10k_avg',    name: '10,000 Video Views (Avg)',      price: 2000, delivery: '2hrs',  desc: 'Average quality', service_id: 3137, quantity: 10000 },
      { id: 'tb_fb_v500_hq',     name: '500 Video Views (HQ)',          price: 170,  delivery: '3hrs',  desc: 'High quality',    service_id: 3138, quantity: 500   },
      { id: 'tb_fb_v10k_hq',     name: '10,000 Video Views (HQ)',       price: 3000, delivery: '3hrs',  desc: 'High quality',    service_id: 3138, quantity: 10000 },
    ]
  },
  {
    id: 'youtube', name: 'YouTube', color: '#ff0000',
    packages: [
      { id: 'tb_yt_s50_avg',   name: '50 Subscribers (Avg)',   price: 3600,  delivery: '65hrs', desc: 'Average quality', service_id: 3056, quantity: 50    },
      { id: 'tb_yt_s500_avg',  name: '500 Subscribers (Avg)',  price: 34000, delivery: '65hrs', desc: 'Average quality', service_id: 3056, quantity: 500   },
      { id: 'tb_yt_s50_hq',    name: '50 Subscribers (HQ)',    price: 4500,  delivery: 'varies',desc: 'High quality',    service_id: 3058, quantity: 50    },
      { id: 'tb_yt_s500_hq',   name: '500 Subscribers (HQ)',   price: 38000, delivery: 'varies',desc: 'High quality',    service_id: 3058, quantity: 500   },
      { id: 'tb_yt_v100_avg',  name: '100 Views (Avg)',        price: 200,   delivery: '6hrs',  desc: 'Average quality', service_id: 3061, quantity: 100   },
      { id: 'tb_yt_v1k_avg',   name: '1,000 Views (Avg)',      price: 2800,  delivery: '6hrs',  desc: 'Average quality', service_id: 3061, quantity: 1000  },
      { id: 'tb_yt_v100_hq',   name: '100 Views (HQ)',         price: 300,   delivery: '4hrs',  desc: 'High quality',    service_id: 3062, quantity: 100   },
      { id: 'tb_yt_v1k_hq',    name: '1,000 Views (HQ)',       price: 4000,  delivery: '4hrs',  desc: 'High quality',    service_id: 3062, quantity: 1000  },
      { id: 'tb_yt_v5k_avg',   name: '5,000 Views (Avg)',      price: 14000, delivery: '6hrs',  desc: 'Average quality', service_id: 3061, quantity: 5000  },
      { id: 'tb_yt_v5k_hq',    name: '5,000 Views (HQ)',       price: 20000, delivery: '4hrs',  desc: 'High quality',    service_id: 3062, quantity: 5000  },
      { id: 'tb_yt_l20_avg',   name: '20 Likes (Avg)',          price: 140,   delivery: '36min', desc: 'Average quality', service_id: 3080, quantity: 20    },
      { id: 'tb_yt_l500_avg',  name: '500 Likes (Avg)',         price: 3000,  delivery: '36min', desc: 'Average quality', service_id: 3080, quantity: 500   },
      { id: 'tb_yt_l10_hq',    name: '10 Likes (HQ)',           price: 140,   delivery: '3min',  desc: 'High quality',    service_id: 3149, quantity: 10    },
      { id: 'tb_yt_l500_hq',   name: '500 Likes (HQ)',          price: 6300,  delivery: '3min',  desc: 'High quality',    service_id: 3149, quantity: 500   },
      { id: 'tb_yt_l1k_avg',   name: '1,000 Likes (Avg)',       price: 6000,  delivery: '36min', desc: 'Average quality', service_id: 3080, quantity: 1000  },
      { id: 'tb_yt_l1k_hq',    name: '1,000 Likes (HQ)',        price: 12500, delivery: '3min',  desc: 'High quality',    service_id: 3149, quantity: 1000  },
    ]
  },
  {
    id: 'telegram', name: 'Telegram', color: '#0088cc',
    packages: [
      { id: 'tb_tg_m500_avg',     name: '500 Members (Avg)',        price: 2100, delivery: '4hrs',  desc: 'Channel / Group',    service_id: 3143, quantity: 500   },
      { id: 'tb_tg_m500_hq',      name: '500 Members (HQ)',         price: 2900, delivery: '28min', desc: 'Channel / Group',    service_id: 3144, quantity: 500   },
      { id: 'tb_tg_m1k_avg',      name: '1,000 Members (Avg)',      price: 4200, delivery: '4hrs',  desc: 'Channel / Group',    service_id: 3143, quantity: 1000  },
      { id: 'tb_tg_m1k_hq',       name: '1,000 Members (HQ)',       price: 5800, delivery: '28min', desc: 'Channel / Group',    service_id: 3144, quantity: 1000  },
      { id: 'tb_tg_v2k',          name: '2,000 Post Views',         price: 140,  delivery: '16min', desc: 'High quality',       service_id: 2801, quantity: 2000  },
      { id: 'tb_tg_v10k',         name: '10,000 Post Views',        price: 700,  delivery: '16min', desc: 'High quality',       service_id: 2801, quantity: 10000 },
      { id: 'tb_tg_v50k',         name: '50,000 Post Views',        price: 3400, delivery: '16min', desc: 'High quality',       service_id: 2801, quantity: 50000 },
      { id: 'tb_tg_autoviews',    name: 'Auto Views (New & Old)',   price: 100,  delivery: '1hr',   desc: 'Per 10k views',      service_id: 2804, quantity: 10000 },
      { id: 'tb_tg_react_pos',    name: '1,000 Positive Reactions', price: 150,  delivery: '7min',  desc: '👍❤️🔥🎉',           service_id: 2733, quantity: 1000  },
      { id: 'tb_tg_react_neg',    name: '1,000 Negative Reactions', price: 150,  delivery: '4min',  desc: '👎😢😱😡',           service_id: 2734, quantity: 1000  },
      { id: 'tb_tg_react_heart',  name: '1,000 Reactions ❤️',       price: 150,  delivery: '22min', desc: 'Heart reaction',     service_id: 2735, quantity: 1000  },
      { id: 'tb_tg_react_fire',   name: '1,000 Reactions 🔥',       price: 150,  delivery: '3min',  desc: 'Fire reaction',      service_id: 2736, quantity: 1000  },
      { id: 'tb_tg_react_party',  name: '1,000 Reactions 🤣',       price: 150,  delivery: '5min',  desc: 'Laughing reaction',  service_id: 2737, quantity: 1000  },
      { id: 'tb_tg_react_thumbs', name: '1,000 Reactions 👍',       price: 150,  delivery: '2min',  desc: 'Thumbs up reaction', service_id: 2738, quantity: 1000  },
    ]
  },
]
